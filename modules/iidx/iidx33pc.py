...
@router.post("/{gameinfo}/IIDX33pc/get")
async def iidx33pc_get(request: Request):
    ...
    response = E.response(
        E.IIDX33pc(
            E.pcdata(
                ...
                d_laneobj_brignt=profile.get("s_laneobj_brignt", 0),
                ...
                s_laneobj_brignt=profile.get("s_laneobj_brignt", 0),
            ...
            E.lightning_setting(
                ...
                brightness_bg=profile.get("lightning_setting_brightness_bg", 0),
                brightness_concentration=profile.get("lightning_setting_brightness_concentration", 0),
                assistant_disp_type=profile.get("lightning_setting_assistant_disp_type", 0),
                assistant_last_tab=profile.get("lightning_setting_assistant_last_tab", 0),
                assistant_chara=profile.get("lightning_setting_assistant_chara", 0),
            ),
            E.arena_data(
                E.achieve_data(
                    play_style=0,
...
@router.post("/{gameinfo}/IIDX33pc/common")
async def iidx33pc_common(request: Request):
    request_info = await core_process_request(request)
    game_version = request_info["game_version"]
...
@router.post("/{gameinfo}/IIDX33pc/save")
async def iidx33pc_save(request: Request):
    request_info = await core_process_request(request)
    game_version = request_info["game_version"]
    ...
    response = E.response(E.IIDX33pc(iidxid=xid, cltype=clt))

    response_body, response_headers = await core_prepare_response(request, response)
    return Response(content=response_body, headers=response_headers)


@router.post("/{gameinfo}/IIDX33pc/visit")
async def iidx33pc_visit(request: Request):
    request_info = await core_process_request(request)
...
@router.post("/{gameinfo}/IIDX33pc/getLaneGachaTicket")
async def iidx33pc_getlanegachaticket(request: Request):
    request_info = await core_process_request(request)
...
@router.post("/{gameinfo}/IIDX33pc/consumeLaneGachaTicket")
async def iidx33pc_consumelanegachaticket(request: Request):
    request_info = await core_process_request(request)

    response = E.response(E.IIDX33pc())

    response_body, response_headers = await core_prepare_response(request, response)
    return Response(content=response_body, headers=response_headers)


@router.post("/{gameinfo}/IIDX33pc/drawLaneGacha")
async def iidx33pc_drawlanegacha(request: Request):
    request_info = await core_process_request(request)
...
@router.post("/{gameinfo}/IIDX33pc/eaappliresult")
async def iidx33pc_eaappliresult(request: Request):
    request_info = await core_process_request(request)
...
@router.post("/{gameinfo}/IIDX33pc/playstart")
async def iidx33pc_playstart(request: Request):
    request_info = await core_process_request(request)
...
@router.post("/{gameinfo}/IIDX33pc/playend")
async def iidx33pc_playend(request: Request):
    request_info = await core_process_request(request)
...
@router.post("/{gameinfo}/IIDX33pc/delete")
async def iidx33pc_delete(request: Request):
    request_info = await core_process_request(request)
...
@router.post("/{gameinfo}/IIDX33pc/logout")
async def iidx33pc_logout(request: Request):
    request_info = await core_process_request(request)
...
@router.post("/{gameinfo}/IIDX33pc/getCompeInfo")
async def iidx33pc_getcompeinfo(request: Request):
    request_info = await core_process_request(request)
