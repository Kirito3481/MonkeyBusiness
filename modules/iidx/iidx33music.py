...
@router.post("/{gameinfo}/IIDX33music/getrank")
async def iidx33music_getrank(request: Request):
...
@router.post("/{gameinfo}/IIDX33music/crate")
async def iidx33music_crate(request: Request):
    request_info = await core_process_request(request)
    game_version = request_info["game_version"]
    ...
    response = E.response(
        E.IIDX33music(*[E.c(crate[k] + fcrate[k], mid=k, __type="s32") for k in crate])
    )
...
@router.post("/{gameinfo}/IIDX33music/reg")
async def iidx33music_reg(request: Request):
    request_info = await core_process_request(request)
    game_version = request_info["game_version"]
...
@router.post("/{gameinfo}/IIDX33music/appoint")
async def iidx33music_appoint(request: Request):
    request_info = await core_process_request(request)
    ...
    response = E.response(E.IIDX33music(*vals))

    response_body, response_headers = await core_prepare_response(request, response)
    return Response(content=response_body, headers=response_headers)


@router.post("/{gameinfo}/IIDX33music/arenaCPU")
async def iidx33music_arenacpu(request: Request):
    request_info = await core_process_request(request)
...
@router.post("/{gameinfo}/IIDX33music/retry")
async def iidx33music_retry(request: Request):
    request_info = await core_process_request(request)
...
@router.post("/{gameinfo}/IIDX33music/play")
async def iidx33music_play(request: Request):
    request_info = await core_process_request(request)

    response = E.response(E.IIDX33music())

    response_body, response_headers = await core_prepare_response(request, response)
    return Response(content=response_body, headers=response_headers)


@router.post("/{gameinfo}/IIDX33music/nosave")
async def iidx33music_nosave(request: Request):
    request_info = await core_process_request(request)
...
@router.post("/{gameinfo}/IIDX33music/getranksub")
async def iidx33music_getranksub(request: Request):
    request_info = await core_process_request(request)
...
@router.post("/{gameinfo}/IIDX33music/movieinfo")
async def iidx33music_movieinfo(request: Request):
    request_info = await core_process_request(request)
